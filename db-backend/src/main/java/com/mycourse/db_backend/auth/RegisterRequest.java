...
/**
 * 构造RegisterRequest，并注入当前类运行所需的依赖对象。
 */
...
@java.lang.Override
    public java.lang.String toString() {
        return "RegisterRequest(userNo=" + this.getUserNo() + ", realName=" + this.getRealName() + ", phone=" + this.getPhone() + ", email=" + this.getEmail() + ", password=" + this.getPassword() + ", userType=" + this.getUserType() + ")";
    }
}
